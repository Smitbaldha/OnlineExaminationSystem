...
public class adminforgotpassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Admin Forgot Password");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            try {
                ...
                ResultSet rs = st.executeQuery("SELECT * FROM online_exam.admin WHERE staffcode= '"+staffcode+"' and username= '"+username+"' and contactno= '"+contactno+"' and email= '"+email+"' and answer= '"+answer+"';");
